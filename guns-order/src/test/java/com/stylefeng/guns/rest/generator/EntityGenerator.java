...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("E:\\IDEA-WorkSpace\\guns\\guns-order\\src\\main\\java");//这里写你自己的java目录
        ...
        strategy.setTablePrefix(new String[]{"mooc_"});// 此处可以修改为您的表前缀
        strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略
        strategy.setInclude(new String[]{"mooc_order_2017_t","mooc_order_t","mooc_order_2018_t"});

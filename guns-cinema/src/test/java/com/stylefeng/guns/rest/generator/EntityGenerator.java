...
public class EntityGenerator
{
    ...
    public void entityGenerator()
    {
        ...
        gc.setOutputDir("E:\\IDEA-WorkSpace\\guns\\guns-cinema\\src\\main\\java");//这里写你自己的java目录
        ...
        strategy.setInclude("mtime_brand_dict_t", "mtime_area_dict_t", "mtime_hall_dict_t", "mtime_cinema_t", "mtime_field_t", "mtime_hall_film_info_t");

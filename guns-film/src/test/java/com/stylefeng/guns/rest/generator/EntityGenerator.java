...
public class EntityGenerator
{
    ...
    public void entityGenerator()
    {
        ...
        gc.setOutputDir("E:\\IDEA-WorkSpace\\guns\\guns-film\\src\\main\\java");//这里写你自己的java目录
        ...
        strategy.setTablePrefix("mtime_");// 此处可以修改为您的表前缀
        //ArrayList<TableFill> table = new ArrayList<>();
        //FieldFill ignore = FieldFill.getIgnore(2);
        //table.add(new TableFill("_t",ignore));
        //strategy.setTableFillList(table);
        strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略
        strategy.setInclude("mtime_banner_t", "mtime_cat_dict_t", "mtime_source_dict_t", "mtime_year_dict_t", "mtime_film_t", "mtime_film_info_t", "mtime_actor_t","mtime_film_actor_t");
